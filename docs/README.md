...
3. [gitops-workflow.md](/root/ArgoCD/docs/gitops-workflow.md) pour comprendre le cycle de reconciliation.
4. [runbook.md](/root/ArgoCD/docs/runbook.md) pour les operations courantes.
5. [glossary.md](/root/ArgoCD/docs/glossary.md) pour les notions importantes.
...
- [Runbook](/root/ArgoCD/docs/runbook.md)
